class DashboardByProductSerializer < ActiveModel::Serializer
  attributes :products, :categories, :net_sales_curr_year, :segment_contribution, :net_sales_growth, :discount_percent
